...
android {
    ...
    lint {
        // O build do CI nao deve quebrar por avisos de estilo, mas erros reais sim.
        abortOnError = true
        warningsAsErrors = false
        disable += setOf("MissingTranslation", "GradleDependency", "AndroidGradlePluginVersion", "ObsoleteLintCustomCheck")
    }
}
